def create_train_argparser():
    ...
    parser.add_argument('--earlie_stop', type=int, default=75, help='how many epochs to earlie stop. If 0, no earlie stop.')
...
def create_kd_argparser():
    ...
    parser.add_argument('--gamma', type=float, help='gamma used in learning rate decay')
    parser.add_argument('--seed', type=int, default=0, help='seed to function init_seeds')
    parser.add_argument('--earlie_stop', type=int, default=25, help='how many epochs to earlie stop. If 0, no earlie stop.')
    # Teacher parameters
